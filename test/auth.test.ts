...
import { checkAuthentication, saveAuthCache, clearAuthCache } from '../src/auth/lib/authCache';
...
describe('authenticate', () => {
  beforeEach(() => {
    ...
    mockPassword.mockImplementation(() =>
      Promise.resolve('skey_c3c32afa0432d73c39e32f2bca0c1f7f')
    );
...
describe('fetchProjects', () => {
  it('should fetch projects successfully', async () => {
    const mockProjects = [
      {
        _creationTime: 1726083782137.0386,
         _id: 'jh76gdh3z766dx74ag50syk1h570jjs1',
         apiKeys: [],
         createdAt: 1726083782137,
         description: 'hamza',
         name: 'hamza',
         updatedAt: 1726083782137,
         userId: 'user_2lIMrqfvKXIV6zGC9jr1TY5TsAw',
         userName: 'Hamza',
         userProfile:
